import { EventId, SuiJsonRpcClient, SuiEvent, SuiEventFilter } from '@mysten/sui/jsonRpc';
...
const runEventJob = async (client: SuiJsonRpcClient, tracker: EventTracker, cursor: SuiEventsCursor) => {
